...
(function (b, f) {
  ...
  b.fn.jPlayer = function (a) {
    ...
    a = !c && d.length ? b.extend.apply(null, [true, a].concat(d)) : a;
    if (c && "_" === a.charAt(0)) return e;
    c ? this.each(function () {
      var c = b(this).data("jPlayer"), h = c && b.isFunction(c[a]) ? c[a].apply(c, d) : c;
      if (h !== c && h !== f) return e = h, false;
    }) : this.each(function () {
  ...
  j.browser && (b.jPlayer.browser[j.browser] = true, b.jPlayer.browser.version = j.version);
  j = b.jPlayer.uaPlatform(navigator.userAgent);
  j.platform && (b.jPlayer.platform[j.platform] = true, b.jPlayer.platform.mobile = !j.tablet, b.jPlayer.platform.tablet = !!j.tablet);
  ...
  b.jPlayer.nativeFeatures = {init: function () {
    ...
    if (b.spec) {
      var k = d[b.spec];
      b.api = {fullscreenEnabled: true, fullscreenElement: function (b) {
        b = b ? b : a;
        return b[k[1]];
    ...
    } else b.api = {fullscreenEnabled: false, fullscreenElement: function () {
      return null;
    }, requestFullscreen: function () {}, exitFullscreen: function () {}}, b.event = {};
  }};
  ...
  var n = function (a) {
    ...
    c && (b.each(b.jPlayer.keyIgnoreElementNames.split(/\s+/g), function (b, c) {
      if (a.target.nodeName.toUpperCase() === c.toUpperCase()) return d = true, false;
    }), d || b.each(c.options.keyBindings, function (d, g) {
      if (g && a.which === g.key && b.isFunction(g.fn)) return a.preventDefault(), g.fn(c), false;
    }));
  };
  ...
  b.jPlayer.keys(true);
  b.jPlayer.prototype = {count: 0, version: {script: "2.4.0", needFlash: "2.4.0", flash: "unknown"}, options: {swfPath: "js", solution: "html, flash", supplied: "mp3", preload: "metadata", volume: 0.8, muted: false, wmode: "opaque", backgroundColor: "#000000", cssSelectorAncestor: "#jp_container_1", cssSelector: {videoPlay: ".jp-video-play", play: ".jp-play", pause: ".jp-pause", stop: ".jp-stop", seekBar: ".jp-seek-bar", playBar: ".jp-play-bar", mute: ".jp-mute", unmute: ".jp-unmute", volumeBar: ".jp-volume-bar", volumeBarValue: ".jp-volume-bar-value", volumeMax: ".jp-volume-max", currentTime: ".jp-current-time", duration: ".jp-duration", fullScreen: ".jp-full-screen", restoreScreen: ".jp-restore-screen", repeat: ".jp-repeat", repeatOff: ".jp-repeat-off", gui: ".jp-gui", noSolution: ".jp-no-solution"}, smoothPlayBar: false, fullScreen: false, fullWindow: false, autohide: {restored: false, full: true, fadeIn: 200, fadeOut: 600, hold: 1e3}, loop: false, repeat: function (a) {
    a.jPlayer.options.loop ? b(this).unbind(".jPlayerRepeat").bind(b.jPlayer.event.ended + ".jPlayer.jPlayerRepeat", function () {
      b(this).jPlayer("play");
    }) : b(this).unbind(".jPlayerRepeat");
  }, nativeVideoControls: {}, noFullWindow: {msie: /msie [0-6]\./, ipad: /ipad.*?os [0-4]\./, iphone: /iphone/, ipod: /ipod/, android_pad: /android [0-3]\.(?!.*?mobile)/, android_phone: /android.*?mobile/, blackberry: /blackberry/, windows_ce: /windows ce/, iemobile: /iemobile/, webos: /webos/}, noVolume: {ipad: /ipad/, iphone: /iphone/, ipod: /ipod/, android_pad: /android(?!.*?mobile)/, android_phone: /android.*?mobile/, blackberry: /blackberry/, windows_ce: /windows ce/, iemobile: /iemobile/, webos: /webos/, playbook: /playbook/}, timeFormat: {}, keyEnabled: false, audioFullScreen: false, keyBindings: {play: {key: 32, fn: function (a) {
    ...
    b.each(this.solutions, function (c, d) {
      if (0 === c) a[d].desired = true; else {
        var e = false, f = false;
        b.each(a.formats, function (b, c) {
          a[a.solutions[0]].canPlay[c] && ("video" === a.format[c].media ? f = true : e = true);
        });
    ...
    b.each(this.solutions, function (c, d) {
      b.each(a.formats, function (b, c) {
        if (a[d].support[c]) return a[d].used = true, false;
      });
    });
    this._resetActive();
    this._resetGate();
    ...
    b.each(a, function (a, b) {
      if (b && b.test(c)) return d = true, false;
    });
    return d;
    ...
    a.addEventListener("progress", function () {
      c.gate && (d.internal.cmdsIgnored && 0 < this.readyState && (d.internal.cmdsIgnored = false), d._getHtmlStatus(a), d._updateInterface(), d._trigger(b.jPlayer.event.progress));
    }, false);
    ...
    a.addEventListener("play", function () {
      c.gate && (d._updateButtons(true), d._html_checkWaitForPlay(), d._trigger(b.jPlayer.event.play));
    }, false);
    a.addEventListener("playing", function () {
      c.gate && (d._updateButtons(true), d._seeked(), d._trigger(b.jPlayer.event.playing));
    }, false);
    a.addEventListener("pause", function () {
      c.gate && (d._updateButtons(false), d._trigger(b.jPlayer.event.pause));
    }, false);
    ...
    a.addEventListener("ended", function () {
      c.gate && (b.jPlayer.browser.webkit || (d.htmlElement.media.currentTime = 0), d.htmlElement.media.pause(), d._updateButtons(false), d._getHtmlStatus(a, true), d._updateInterface(), d._trigger(b.jPlayer.event.ended));
    }, false);
    a.addEventListener("error", function () {
      c.gate && (d._updateButtons(false), d._seeked(), d.status.srcSet && (clearTimeout(d.internal.htmlDlyCmdId), d.status.waitForLoad = true, d.status.waitForPlay = true, d.status.video && !d.status.nativeVideoControls && d.internal.video.jq.css({width: "0px", height: "0px"}), d._validString(d.status.media.poster) && !d.status.nativeVideoControls && d.internal.poster.jq.show(), d.css.jq.videoPlay.length && d.css.jq.videoPlay.show(), d._error({type: b.jPlayer.error.URL, context: d.status.src, message: b.jPlayer.errorMsg.URL, hint: b.jPlayer.errorHint.URL})));
    }, false);
    ...
    b.each(this.formats, function (e, f) {
      ...
      b.each(c.solutions, function (b, e) {
        if (c[e].support[f] && c._validString(a[f])) {
          var g = "html" === e;
          j ? (g ? (c.html.video.gate = true, c._html_setVideo(a), c.html.active = true) : (c.flash.gate = true, c._flash_setVideo(a), c.flash.active = true), c.css.jq.videoPlay.length && c.css.jq.videoPlay.show(), c.status.video = true) : (g ? (c.html.audio.gate = true, c._html_setAudio(a), c.html.active = true) : (c.flash.gate = true, c._flash_setAudio(a), c.flash.active = true), c.css.jq.videoPlay.length && c.css.jq.videoPlay.hide(), c.status.video = false);
          d = true;
          return false;
        }
      });
  ...
  }, volumeBarValue: function () {}, _updateVolume: function (a) {
  ...
  }, playBar: function () {}, repeat: function () {
    this._loop(true);
  }, repeatOff: function () {
    this._loop(false);
  }, _loop: function (a) {
    ...
    var d = a;
    if (0 === arguments.length) return b.extend(true, {}, this.options);
    if ("string" === typeof a) {
      var e = a.split(".");
      if (c === f) {
        for (var d = b.extend(true, {}, this.options), g = 0; g < e.length; g++) if (d[e[g]] !== f) d = d[e[g]]; else return this._warning({type: b.jPlayer.warning.OPTION_KEY, context: a, message: b.jPlayer.warningMsg.OPTION_KEY, hint: b.jPlayer.warningHint.OPTION_KEY}), f;
        return d;
      }
    ...
    switch (a) {
      ...
      case "keyEnabled":
        ...
        break;
      case "keyBindings":
        this.options[a] = b.extend(true, {}, this.options[a], c);
        break;
    ...
    this.css.jq.gui.length && (this.css.jq.gui.stop(true, true), clearTimeout(this.internal.autohideId), this.element.unbind(".jPlayerAutohide"), this.css.jq.gui.unbind(".jPlayerAutohide"), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind("mousemove.jPlayer.jPlayerAutohide", b), this.css.jq.gui.bind("mousemove.jPlayer.jPlayerAutohide", b), this.css.jq.gui.hide()) : this.css.jq.gui.show());
  }, fullScreen: function () {
    ...
    c.api.fullscreenEnabled && c.event.fullscreenchange && ("function" !== typeof this.internal.fullscreenchangeHandler && (this.internal.fullscreenchangeHandler = function () {
      a._fullscreenchange();
    }), document.addEventListener(c.event.fullscreenchange, this.internal.fullscreenchangeHandler, false));
    ...
    this.options.fullScreen && !b.jPlayer.nativeFeatures.fullscreen.api.fullscreenElement() && this._setOption("fullScreen", false);
    ...
    b.each(this.formats, function (b, e) {
      if (c.html.support[e] && a[e]) return c.status.src = a[e], c.status.format[e] = true, c.status.formatType = e, false;
    });
    ...
    this.status.waitForPlay && (this.status.waitForPlay = false, this.css.jq.videoPlay.length && this.css.jq.videoPlay.hide(), this.status.video && (this.internal.poster.jq.hide(), this.internal.video.jq.css({width: this.status.width, height: this.status.height})));
    ...
    this.status.waitForPlay && (this.status.waitForPlay = false, this.css.jq.videoPlay.length && this.css.jq.videoPlay.hide(), this.status.video && (this.internal.poster.jq.hide(), this.internal.flash.jq.css({width: this.status.width, height: this.status.height})));
    ...
    var b = false;
    this._getFlashPluginVersion() >= a && (b = true);
    return b;
